...
import com.example.sinyal.databinding.ActivityPickLocationBinding
import com.example.sinyal.helper.LocationConvert
...
class PickLocationActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.setOnMapClickListener {
            ...
            markerOptions.title(LocationConvert.getStringAddress(it, this))
            mMap.clear()
    ...
    private fun showAlertDialog(latlng: LatLng?) {
        val address = LocationConvert.getStringAddress(latlng, this)
